...
# -----------------------------------------------------------------------------
# 1. Asset Resolution & First Streamlit Command
# -----------------------------------------------------------------------------
SCRIPT_DIR = Path(__file__).parent.resolve()
LOGO_FILE = SCRIPT_DIR / "logotype.jpeg"

favicon_img = "🌤️"
if LOGO_FILE.exists():
    try:
        favicon_img = Image.open(LOGO_FILE)
    except Exception:
        favicon_img = "🌤️"
...
# -----------------------------------------------------------------------------
# 4. Swedish Geographic Hierarchy
# -----------------------------------------------------------------------------
REGIONS_AND_CITIES: Dict[str, Dict[str, Tuple[float, float]]] = {
    "Västra Götaland": {
        "Göteborg": (57.7089, 11.9746), "Alingsås": (57.9303, 12.5335), "Bengtsfors": (58.9974, 12.2324),
        "Borås": (57.7210, 12.9401), "Falköping": (58.1735, 13.5507), "Hjo": (58.3019, 14.2874),
        "Kungälv": (57.8700, 11.9675), "Lidköping": (58.5052, 13.1577), "Lilla Edet": (58.1333, 12.1333),
        "Lysekil": (58.2740, 11.4350), "Mariestad": (58.7097, 13.8237), "Mölndal": (57.6554, 12.0138),
        "Skara": (58.3866, 13.4384), "Skövde": (58.3912, 13.8451), "Strömstad": (58.9394, 11.1712),
        "Tanumshede": (58.7236, 11.3250), "Tibro": (58.4245, 14.1612), "Tidaholm": (58.1804, 13.9583),
        "Trollhättan": (58.2837, 12.2886), "Ulricehamn": (57.7916, 13.4142), "Uddevalla": (58.3498, 11.9424),
        "Vänersborg": (58.3807, 12.3234), "Åmål": (58.9898, 12.6390),
    },
    "Halland": {
        "Falkenberg": (56.9055, 12.4912), "Halmstad": (56.6745, 12.8578),
        "Kungsbacka": (57.4872, 12.0761), "Laholm": (56.5126, 13.0437), "Varberg": (57.1056, 12.2508),
    },
    "Skåne": {
        "Båstad": (56.4269, 12.8476), "Eslöv": (55.8397, 13.3039), "Helsingborg": (56.0465, 12.6945),
        "Hässleholm": (56.1587, 13.7667), "Höganäs": (56.1997, 12.5579), "Kristianstad": (56.0294, 14.1567),
        "Landskrona": (55.8708, 12.8302), "Lund": (55.7047, 13.1910), "Malmö": (55.6050, 13.0038),
        "Simrishamn": (55.5565, 14.3539), "Staffanstorp": (55.6428, 13.2064), "Trelleborg": (55.3751, 13.1569),
        "Ystad": (55.4297, 13.8204),
    },
    "Blekinge": {
        "Karlshamn": (56.1706, 14.8619), "Karlskrona": (56.1612, 15.5869),
        "Olofström": (56.2775, 14.5330), "Ronneby": (56.2090, 15.2760), "Sölvesborg": (56.0521, 14.5751),
    },
    "Småland": {
        "Eksjö": (57.6664, 14.9720), "Gislaved": (57.3044, 13.5408), "Jönköping": (57.7826, 14.1618),
        "Ljungby": (56.8332, 13.9408), "Nässjö": (57.6531, 14.6968), "Tranås": (58.0372, 14.9784),
        "Värnamo": (57.1860, 14.0400), "Vetlanda": (57.4289, 15.0776), "Växjö": (56.8790, 14.8059),
    },
    "Kalmar län / Öland": {
        "Borgholm": (56.8793, 16.6560), "Emmaboda": (56.6328, 15.5374), "Kalmar": (56.6634, 16.3568),
        "Mönsterås": (57.0417, 16.4430), "Oskarshamn": (57.2646, 16.4484), "Vimmerby": (57.6659, 15.8552),
        "Västervik": (57.7584, 16.6373),
    },
    "Östergötland": {
        "Finspång": (58.7058, 15.7674), "Linköping": (58.4108, 15.6214), "Mjölby": (58.3259, 15.1250),
        "Motala": (58.5371, 15.0365), "Norrköping": (58.5877, 16.1924), "Söderköping": (58.4806, 16.3222),
        "Vadstena": (58.4486, 14.8897),
    },
    "Södermanland": {
        "Eskilstuna": (59.3710, 16.5098), "Katrineholm": (58.9958, 16.2072), "Nyköping": (58.7530, 17.0079),
        "Oxelösund": (58.6706, 17.1017), "Strängnäs": (59.3774, 17.0312),
    },
    "Stockholm": {
        "Stockholm": (59.3293, 18.0686), "Märsta": (59.6216, 17.8548), "Norrtälje": (59.7580, 18.7050),
        "Nynäshamn": (58.9034, 17.9479), "Sollentuna": (59.4280, 17.9509), "Södertälje": (59.1955, 17.6253),
        "Täby": (59.4439, 18.0687), "Upplands Väsby": (59.5184, 17.9113), "Vallentuna": (59.5344, 18.0776),
        "Åkersberga": (59.4794, 18.2997),
    },
    "Uppsala län": {
        "Enköping": (59.6361, 17.0777), "Uppsala": (59.8586, 17.6389), "Östhammar": (60.2596, 18.3741),
    },
    "Västmanland": {
        "Arboga": (59.3939, 15.8388), "Fagersta": (59.9913, 15.7930), "Köping": (59.5140, 15.9926),
        "Sala": (59.9199, 16.6066), "Västerås": (59.6099, 16.5448),
    },
    "Örebro län": {
        "Hallsberg": (59.0642, 15.1103), "Kumla": (59.1278, 15.1435), "Lindesberg": (59.5920, 15.2304),
        "Nora": (59.5193, 15.0396), "Örebro": (59.2753, 15.2134),
    },
    "Värmland": {
        "Arvika": (59.6553, 12.5852), "Filipstad": (59.7124, 14.1683), "Hagfors": (60.0234, 13.6721),
        "Karlstad": (59.3793, 13.5036), "Kristinehamn": (59.3098, 14.1081), "Säffle": (59.1323, 12.9287),
    },
    "Dalarna": {
        "Avesta": (60.1454, 16.1679), "Borlänge": (60.4858, 15.4371), "Falun": (60.6065, 15.6355),
        "Hedemora": (60.2797, 15.9886), "Ludvika": (60.1496, 15.1878), "Mora": (61.0040, 14.5370),
        "Säter": (60.3478, 15.7500), "Älvdalen": (61.2277, 14.0393),
    },
    "Gävleborg": {
        "Bollnäs": (61.3482, 16.3946), "Gävle": (60.6749, 17.1413), "Hudiksvall": (61.7274, 17.1056),
        "Ljusdal": (61.8288, 16.0918), "Sandviken": (60.6186, 16.7758), "Söderhamn": (61.3037, 17.0592),
    },
    "Jämtland": {
        "Åre": (63.3986, 13.0794), "Östersund": (63.1792, 14.6353), "Strömsund": (63.8521, 15.5558),
    },
    "Västernorrland": {
        "Härnösand": (62.6323, 17.9379), "Kramfors": (62.9304, 17.7761), "Sollefteå": (63.1667, 17.2667),
        "Sundsvall": (62.3908, 17.3069), "Örnsköldsvik": (63.2909, 18.7153),
    },
    "Västerbotten": {
        "Lycksele": (64.5954, 18.6735), "Skellefteå": (64.7507, 20.9528), "Storuman": (65.0959, 17.1173),
        "Umeå": (63.8258, 20.2630), "Vilhelmina": (64.6242, 16.6558),
    },
    "Norrbotten": {
        "Arjeplog": (66.0517, 17.8861), "Arvidsjaur": (65.5903, 19.1668), "Boden": (65.8252, 21.6886),
        "Haparanda": (65.8355, 24.1347), "Jokkmokk": (66.6066, 19.8236), "Kalix": (65.8556, 23.1465),
        "Kiruna": (67.8558, 20.2253), "Luleå": (65.5848, 22.1547), "Piteå": (65.3172, 21.4794),
    },
    "Gotland": {
...
# -------------------------------------------------------------
# 5. Translation Dictionary & Helpers
# -------------------------------------------------------------
POLLEN_NAMES_EN: Dict[str, str] = {
    "hassel": "Hazel",
    "al": "Alder",
    "alm": "Elm",
    "björk": "Birch",
    ...
    "gran": "Spruce",
    "tall": "Pine",
    "sälg och viden": "Willow (Sallow/Osier)",
    "gräs": "Grass",
    "gråbo": "Mugwort",
    "malörtsambrosia": "Ragweed (Ambrosia)",
}

def translate_pollen_name(name: Optional[str]) -> str:
    if not name:
        return ""
    clean = str(name).strip().lower()
    return POLLEN_NAMES_EN.get(clean, str(name).capitalize())

# -------------------------------------------------------------
# 6. Categorization, Scales & Content Dictionaries
# -------------------------------------------------------------
LEVELS = [
...
WHO_GUIDELINES = {
    "PM2.5": "WHO 24-hour guideline is 15 µg/m³. Lower is better.",
    "PM10": "WHO 24-hour guideline is 45 µg/m³. Lower is better.",
    "NO₂": "WHO 24-hour guideline is 25 µg/m³. Lower is better.",
    "O₃": "WHO 8-hour guideline is 100 µg/m³. Lower is better.",
    "SO₂": "WHO 24-hour guideline is 40 µg/m³. Lower is better.",
}

POLLUTANT_CONCENTRATION_THRESHOLDS: Dict[str, List[Tuple[float, str]]] = {
    "PM2.5": [(10, "Good"), (20, "Moderate"), (25, "Poor"), (50, "Dangerous"), (float("inf"), "Hazardous")],
    "PM10": [(20, "Good"), (40, "Moderate"), (50, "Poor"), (100, "Dangerous"), (float("inf"), "Hazardous")],
    "NO₂": [(40, "Good"), (90, "Moderate"), (120, "Poor"), (230, "Dangerous"), (float("inf"), "Hazardous")],
    "O₃": [(50, "Good"), (100, "Moderate"), (130, "Poor"), (240, "Dangerous"), (float("inf"), "Hazardous")],
    "SO₂": [(100, "Good"), (200, "Moderate"), (350, "Poor"), (500, "Dangerous"), (float("inf"), "Hazardous")],
}

def get_pollutant_level_by_conc(pollutant: str, val: Optional[float]) -> str:
    if val is None or pd.isna(val):
        return "Unavailable"
    thresholds = POLLUTANT_CONCENTRATION_THRESHOLDS.get(pollutant)
    if not thresholds:
        return "Good"
...
POLLUTANT_DETAILED_SCALES: Dict[str, Dict[str, str]] = {
    "PM2.5": {
        "unit": "µg/m³",
        "Good": "0 – 10 µg/m³",
        "Moderate": "10 – 20 µg/m³",
        "Poor": "20 – 25 µg/m³",
        "Dangerous": "25 – 50 µg/m³",
        "Hazardous": "50+ µg/m³",
    },
    "PM10": {
        "unit": "µg/m³",
...
POLLUTANTS = {
    "PM2.5": {
        ...
        "plain": "Tiny particles that can travel deep into the lungs and affect long-term health.",
        "asthma": "Can irritate sensitive airways and make breathing tighter when levels rise.",
        "sources": "Combustion, vehicle exhaust, wood smoke, fires, and industry.",
    },
    "PM10": {
        "value_key": "pm10",
        ...
        "asthma": "Road dust and coarse particles can trigger coughing, throat, and airway irritation.",
        "sources": "Studded tire road wear, construction, dry soil, sand, and industry.",
    },
    "NO₂": {
        "value_key": "nitrogen_dioxide",
        "aqi_key": "european_aqi_nitrogen_dioxide",
        "short": "Combustion gas",
        "plain": "A pungent gas that irritates bronchial airways and lungs.",
        "asthma": "Higher NO₂ can be uncomfortable for people with asthma, especially near roadways.",
        "sources": "Road traffic, heavy diesel engines, and heating fuels.",
    },
    "O₃": {
        "value_key": "ozone",
        "aqi_key": "european_aqi_ozone",
        "short": "Ground ozone",
        "plain": "Secondary pollutant formed near the ground when sunlight reacts with emissions.",
        "asthma": "Ozone can make deep breathing and endurance exercise feel harder for sensitive airways.",
        "sources": "Forms in warm sunlight from reactions between vehicle and industrial emissions.",
    },
    "SO₂": {
        "value_key": "sulphur_dioxide",
        "aqi_key": "european_aqi_sulphur_dioxide",
        "short": "Sulfur gas",
        "plain": "A sharp, sulfur-containing gas that can trigger airway constriction.",
        "asthma": "People with asthma are especially sensitive even during short exposures.",
        "sources": "Cargo shipping, refineries, coal/oil burning, and heavy fuel combustion.",
    },
}
...
def get_pollen_color(level_num: Any) -> str:
    ...
    try:
        ...
        if val <= 0:
            ...
            return "#0F766E"  # Good (Green)
        elif val == 2:
            return "#2563EB"  # Moderate (Blue)
        elif val == 3:
            return "#7C3AED"  # Poor (Purple)
        elif val == 4:
            return "#DB2777"  # Dangerous (Pink)
        else:
            return "#7F1D5A"  # Hazardous (Dark Pink / 5, 6, 7)
...
# -------------------------------------------------------------
# 7. Interactive Pollutant Pop-up (Streamlit Dialog)
# -------------------------------------------------------------
@st.dialog("Pollutant Health & Severity Profile")
def show_pollutant_details(name: str):
    info = POLLUTANTS[name]
    who_guideline = WHO_GUIDELINES.get(name, "No specific concentration thresholds.")
    
    st.markdown(f"### {name} — {info['short']}")
    st.markdown(f"**What it is:** {info['plain']}")
    st.markdown(f"**Asthma & Sensitive Airways:** {info['asthma']}")
    st.markdown(f"**Primary Sources:** {info['sources']}")
    
    st.info(f"**Severity & Guidelines:** {who_guideline}")
    st.caption("Concentrations exceeding recommended guidelines correlate with higher airway irritation risks.")

# -------------------------------------------------------------
# 8. Storage & Onboarding Layer
# -------------------------------------------------------------
...
# Top handler: Apply click from map nationwide
pending_city = st.session_state.pop("_pending_city", None)
if pending_city and pending_city in CITY_TO_REGION:
    st.session_state.selected_city = pending_city
    st.session_state.selected_region = CITY_TO_REGION[pending_city]
...
def fetch_city_pollution(lat: float, lon: float) -> Tuple[Dict[str, Any], pd.DataFrame]:
    current_fields = [
        ...
        "european_aqi_sulphur_dioxide", "pm2_5", "pm10", "nitrogen_dioxide",
    ...
    params = {
        ...
        "hourly": hourly_fields, "timezone": "Europe/Stockholm",
        "forecast_days": 2, "domains": "cams_europe",
    }
    try:
    ...
    fallback_curr = {
        "european_aqi": 18, "european_aqi_pm2_5": 14, "european_aqi_pm10": 16,
        "european_aqi_nitrogen_dioxide": 18, "european_aqi_ozone": 24,
        "european_aqi_sulphur_dioxide": 6, "pm2_5": 4.5, "pm10": 11.2,
        "nitrogen_dioxide": 9.4, "ozone": 34.0, "sulphur_dioxide": 1.5,
    }
    fallback_hourly = pd.DataFrame({
        "time": [datetime.now().strftime("%Y-%m-%dT%H:00")],
        "european_aqi": [18], "pm2_5": [4.5], "pm10": [11.2],
        "nitrogen_dioxide": [9.4], "ozone": [34.0],
    })
    return fallback_curr, fallback_hourly

@st.cache_data(ttl=300, show_spinner=False)
def fetch_national_air() -> pd.DataFrame:
    all_city_items = []
    for reg, cities in REGIONS_AND_CITIES.items():
        for city, coords in cities.items():
            all_city_items.append((city, coords))
            
    latitudes = ",".join(str(coords[0]) for _, coords in all_city_items)
    longitudes = ",".join(str(coords[1]) for _, coords in all_city_items)
    params = {
        "latitude": latitudes,
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            if isinstance(payload, dict):
                payload = [payload]
            rows = []
            for (city, coords), item in zip(all_city_items, payload):
    ...
    return pd.DataFrame([
        ...
        for city, coords in all_city_items
    ])
...
def calculate_viability(aqi, temp, wind, precip, pollen_level):
    ...
    if pollen_level is not None and not pd.isna(pollen_level):
        if pollen_level >= 5:
            score -= 20
            reasons.append(f"High pollen load (Level {pollen_level}/7)")
        elif pollen_level >= 3:
            score -= 10
            reasons.append(f"Elevated seasonal pollen (Level {pollen_level}/7)")
...
# -------------------------------------------------------------
# 11. Main Dashboard Header & Navigation
# -------------------------------------------------------------
col_logo, col_heading = st.columns([0.08, 0.92], vertical_alignment="center")

with col_logo:
    if LOGO_FILE.exists():
        st.image(str(LOGO_FILE), width=52)

with col_heading:
    st.title("Air-aware: Environmental Monitor")
    ...
    for cat_data in summary.values():
        for entry in cat_data.get("pollen", []):
            ...
            if isinstance(numeric, (int, float)) and not pd.isna(numeric):
                numeric = int(numeric)
                p_eng = translate_pollen_name(entry.get("pollen"))
                if numeric > max_level:
                    max_level = numeric
                    dominant = [p_eng]
                elif numeric == max_level and numeric > 0:
                    dominant.append(p_eng)
    ...
    if not pollen_benchmark.get("available"):
                ...
                with st.popover(
                    ...
                    if not entries:
                        ...
                        for entry in entries:
                            ...
                            e_color = get_pollen_color(e_num)
                            e_label = entry.get("level", "unavailable").capitalize()
                            
                            num_txt = f" ({e_num}/7)" if isinstance(e_num, (int, float)) else ""
                            st.markdown(
                                f"<div style='display:flex;align-items:center;gap:8px;padding:4px 0;'>"
                                f"<span style='width:12px;height:12px;border-radius:2px;"
                                f"background:{e_color};display:inline-block;'></span>"
                                f"<span style='flex:1;'>{eng_name}</span>"
                                f"<span style='color:{e_color};font-weight:700;'>{e_label}{num_txt}</span>"
                                f"</div>",
                                unsafe_allow_html=True,
                            )
        ...
        st.markdown(
            ...
            <div style="margin-top:12px;color:#334155;font-size:.95rem;">
                Highest pollen severity right now: ({max_level}/7){dominant_line}
        ...
        if not pollen_history.empty:
            ...
            if pollen_view == "Category":
                ...
                fig_pollen = px.line(
                    ...
                    labels={"date": "Date", "numeric_level": "Level (0–7)", group_col: ""},
                )
            else:
                fig_pollen = px.line(
                    chart_df,
            ...
            fig_pollen.update_yaxes(range=[-0.2, 7.2], dtick=1)
...
with scale_col:
    selected_scale_pol = st.selectbox(
        "Select a pollutant to examine its complete severity scale:",
        list(POLLUTANTS.keys()),
        key="dynamic_scale_selector",
    )

scale_info = POLLUTANTS[selected_scale_pol]
scale_who = WHO_GUIDELINES.get(selected_scale_pol, "No strict concentration thresholds listed.")
pol_scale_data = POLLUTANT_DETAILED_SCALES.get(selected_scale_pol, {})
pol_unit = pol_scale_data.get("unit", "µg/m³")

st.markdown(f"**{selected_scale_pol} ({scale_info['short']}) Guidelines:**")
st.info(scale_who)

st.markdown(f"##### Full Severity Breakdown for {selected_scale_pol} ({pol_unit})")

scale_cols = st.columns(5)
for col, (ceiling, level, feel, _, color, icon) in zip(scale_cols, LEVELS):
    conc_range = pol_scale_data.get(level, "N/A")
    score_range = f"0 – 20" if level == "Good" else f"21 – 40" if level == "Moderate" else f"41 – 60" if level == "Poor" else f"61 – 100" if level == "Dangerous" else "101+ pts"
    
    col.markdown(
        f"""
        <div style="border:2px solid {color};border-top:6px solid {color};padding:12px 10px;border-radius:10px;background:{color}10;text-align:center;">
            <div style="font-size:0.95rem;font-weight:800;color:{color};">{icon} {level}</div>
            <div style="font-size:0.82rem;font-weight:700;color:#1e293b;margin:6px 0 2px 0;">{conc_range}</div>
            <div style="font-size:0.75rem;font-weight:600;color:#64748b;">AQI: {score_range}</div>
            <div style="font-size:0.72rem;color:#475569;margin-top:4px;">{feel}</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
# -------------------------------------------------------------
# 14. Visual Forecasts & Driver Analysis
# -------------------------------------------------------------
st.markdown("---")
...
with c_left:
    ...
    for name, info in POLLUTANTS.items():
        val = curr_pol.get(info["value_key"])
        if isinstance(val, (int, float)):
            level_name = get_pollutant_level_by_conc(name, val)
            chart_rows.append({
                "Pollutant": name,
                "Concentration": val,
                "Level": level_name,
    ...
    if chart_rows:
        cdf = pd.DataFrame(chart_rows).sort_values("Concentration", ascending=True)
        fig_bar = px.bar(
            cdf,
            x="Concentration",
            y="Pollutant",
            ...
            title="Current Concentration vs. Severity Level",
...
# -------------------------------------------------------------
# 15. National Air Quality Map (Focus on Selected Region)
# -------------------------------------------------------------
st.markdown("---")
st.markdown(f"### 🗺️ Air Quality Map (Sweden — Focus: {st.session_state.selected_region})")
st.markdown(
    '<div class="map-hint">Click on any city marker on the map to switch your location view directly. Marker colors show current air quality.</div>',
    unsafe_allow_html=True,
)

national_df = fetch_national_air()
col_map, col_summary = st.columns([3.5, 1])
...
if not national_df.empty:
    ...
    with col_map:
        try:
            ...
            if points:
                ...
                if clicked_city and clicked_city in CITY_TO_REGION and clicked_city != st.session_state.selected_city:
                    st.session_state["_pending_city"] = clicked_city
                    st.session_state.selected_city = clicked_city
                    st.session_state.selected_region = CITY_TO_REGION[clicked_city]
                    st.rerun()
        except TypeError:
    ...
    with col_summary:
        ...
        for ceiling, level, feel, _, color, icon in LEVELS:
            st.markdown(
                f"""
                <div style="border-left:5px solid {color};padding:8px 10px;border-radius:6px;background:{color}10;margin-bottom:8px;">
                    <div style="font-size:0.88rem;font-weight:700;color:{color};">{icon} {level}</div>
                    <div style="font-size:0.75rem;color:#475569;">{feel}</div>
                </div>
                """,
                unsafe_allow_html=True,
            )
